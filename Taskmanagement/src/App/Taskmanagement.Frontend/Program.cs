...
//Using one url so that we dont have to use redundantly in each Controller.
...
var baseUrl = builder.Configuration.GetValue<string>("TaskmanagementApiBase");
builder.Services.AddHttpClient("TaskmanagementApi", c =>
{
